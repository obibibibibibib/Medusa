...
public class Ravenb3 {
   ...
   private static final String numberOfUseTracker = "https://pastebin.com/raw/3VfGuW6Z";
   public static final String sourceLocation = "https://github.com/noxito/Medusa";
   public static final String discord = "https://discord.gg/7y5Udvs7nJ";
   public static String[] updateText = {"Your version of Medusa (" + version.getCurrentVersion().replaceAll("-", ".") + ") is outdated!", "Enter the command update into client CommandLine to open the download page", "or just enable the update module to get a message in chat.", "", "Newest version: " + version.getLatestVersion().replaceAll("-", ".")};
